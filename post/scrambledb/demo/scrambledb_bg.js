...
/**
*/
export function demo_blind_table() {
    wasm.demo_blind_table();
}
...
export function __wbg_instanceof_HtmlTableElement_caaef43068dcc329(arg0) {
    let result;
    try {
...
export function __wbg_createCaption_73b6c251ac0f5b01(arg0) {
    const ret = getObject(arg0).createCaption();
    return addHeapObject(ret);
};

export function __wbg_createTHead_3adeaba2cd06c281(arg0) {
    const ret = getObject(arg0).createTHead();
    return addHeapObject(ret);
};

export function __wbg_insertRow_d9f248678aed21da() { return handleError(function (arg0) {
...
export function __wbg_instanceof_HtmlTableRowElement_a2a65c7074138923(arg0) {
    let result;
    try {
...
export function __wbg_insertCell_fe6151aef13aafb1() { return handleError(function (arg0) {
    const ret = getObject(arg0).insertCell();
    return addHeapObject(ret);
}, arguments) };
